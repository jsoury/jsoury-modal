...
var _modalModule = _interopRequireDefault(require("./styles/modal.module.scss"));
...
const Modal = _ref => {
  ...
  return show && /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: _modalModule.default.modal__content,
    ...
    className: _modalModule.default.modal__button,
    onClick: onClose
  }, "Close"))));
};
var _default = Modal;
